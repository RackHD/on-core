...
function GraphModelFactory (Model, Constants, Promise, _) {
    return Model.extend({
        ...
        persistGraphObject: function(graph) {
            // TODO: Implement
            debugger;
        },

        isGraphDone: function(graphId) {
            var query = {
                instanceId: graphId,
                state: 'valid',
                tasks: {
            ...
            return this.findOneMongo(query).then(Boolean);
        },
        ...
        */
        ...
        heartbeatTask: function(graphId, taskId, leaseId) {
            ...
            // TODO: sort needs to be an array according to the node-mongo-native
            // api doc, but mongo query language calls for object, how to
            // make the equivalent of this for the node driver?
            var sort = {
                'updatedAt': -1
            };
            var options = {
