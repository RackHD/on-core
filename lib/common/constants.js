    ...
    var constants = Object.freeze({
        ...
        SecureErase: {
            hdparm: {
                ...
                operation: ['secure-erase', 'secure-erase-enhanced']
            },
            sg_sanitize: { //jshint ignore:line
                protocol: ['SAS'],
                operation: ['block', 'crypto', 'fail']
            },
            ...
            scrub: {
                protocol: ['SAS', 'SATADOM', 'SATA'],
                operations: ['nnsa', 'dod', 'fillzero', 'fillrandom', 'fillff', 'gutmann']
            }
        }
    });
