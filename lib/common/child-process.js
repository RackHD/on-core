...
function ChildProcessFactory (
     ...
     */
    ChildProcess.prototype._run = function (maxBuffer) {
        var self = this;
        ...
        var options = {
            ...
            maxBuffer: maxBuffer || (200*1024)  // nodejs default
        };
    ...
    ChildProcess.prototype._runWithRetries = function(retryCount, delay, retries, maxBuffer) {
        var self = this;
        ...
        return self._deferred.catch(function(e) {
            if (e instanceof Errors.JobKilledError) {
                ...
                .then(function() {
                    return self._runWithRetries(retryCount + 1, delay * 2, retries, maxBuffer);
                });
            } else {
                throw e;
            }
    ...
    ChildProcess.prototype.run = function(options) {
        ...
        if (options.maxBuffer) {
            assert.number(options.maxBuffer);
        }

        return this._runWithRetries(0, options.delay, options.retries, options.maxBuffer);
    };
