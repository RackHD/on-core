...
function ModelFactory (_, assert, Waterline, waterlineProtocol) {
    ...
    return Waterline.Collection.extend({
        ...
        afterCreate: function (record, next) {
            waterlineProtocol.publishRecord(this, 'created', record).catch(function () {});

            next();
        },
        afterUpdate: function (record, next) {
            waterlineProtocol.publishRecord(this, 'updated', record).catch(function () {});

            next();
        },
        afterDestroy: function (records, next) {
            records.forEach(function (record) {
                waterlineProtocol.publishRecord(this, 'destroyed', record).catch(function () {});
            });
