...
function graphProgressFactory(
     ...
     * @param updatePercentage {Boolean} true if need to calculate the task percentage
     */
    GraphProgress.prototype.updateTaskProgress = function(taskId, taskProgress, updatePercentage) {
        var self = this;
