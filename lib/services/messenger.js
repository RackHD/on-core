    ...
    MessengerService.prototype.start = function () {
        ...
        return amqp.connect(uri)
            .then(function (connection) {
                ...
                self.connection.on('close', self.closed.bind(self));
                self.connection.on('error', self.error.bind(self));
    ...
    MessengerService.prototype.stop = function () {
        ...
        if (self.connection) {
            ...
            return Q.all(
                ...
                return Q.ninvoke(self.connection, 'close').then(function () {
