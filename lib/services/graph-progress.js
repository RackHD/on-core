...
function graphProgressServiceFactory(
     ...
     */
    GraphProgressService.prototype.publishGraphStarted = function(graph, swallowError) {
        return this._publishGraphProgress(graph, 'started', swallowError);
    };
    ...
    GraphProgressService.prototype.publishGraphFinished = function(
        ...
        return this._publishGraphProgress(graph, graphState, swallowError);
    };
     ...
     * @memberOf GraphProgressService
     */
    GraphProgressService.prototype.publishTaskStarted = function(task, swallowError) {
     ...
     * @memberOf GraphProgressService
     */
    GraphProgressService.prototype.publishTaskFinished = function(task, swallowError) {
