...
function lookupServiceFactory(
     ...
     */
    LookupService.prototype.findIpMacAddresses = function (id) {
        var self = this;
        assert.isMongoId(id);
        ...
        .then(function() {
		    ...
		    var ipMacAddress = {};
	            ipMacAddress.ipAddress = record.ipAddress;
		    ipMacAddress.macAddress = record.macAddress;
                    ipMacAddresses.push(ipMacAddress);
