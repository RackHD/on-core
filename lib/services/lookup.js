 ...
 * @param  {DhcpService} dhcpService An instance of the DhcpService.
 * @param  {DomainService} domainService An instance of the DomainService.
 * @return {LookupService} An instance of the LookupService.
 */
function lookupServiceFactory(Q, configuration, dhcpService, waterline, assert) {
     ...
     * via a lookup in the DhcpService.
    ...
    LookupService.prototype.ipAddressToMacAddress = function ipAddressToMacAddress(ip) {
        ...
        return dhcpService.lookupIpLease(ip).then(function (lease) {
            return lease.mac;
        });
    };
     ...
     * a lookup using the DhcpService & DomainService.
     ...
     * a lookup using the DhcpService & DomainService. This function will cache
