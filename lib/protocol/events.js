...
function eventsProtocolFactory (
    ...
    EventsProtocol.prototype.publishGraphStarted = function (graphid, status, nodeId) {
        var self = this;
        assert.uuid(graphid);
    ...
    EventsProtocol.prototype.publishGraphFinished = function (graphid, status, nodeId) {
        var self = this;
        assert.uuid(graphid);
        assert.string(status);
