...
function dhcpProtocolFactory (Constants, messenger, assert, _) {
    ...
    DhcpProtocol.prototype.removeLeaseByIp = function removeLeaseByIp(ip) {
        assert.isIP(ip);
    ...
    DhcpProtocol.prototype.subscribeRemoveLeaseByIp = function subscribeRemoveLeaseByIp(callback) {
        assert.func(callback);
