...
taskGraphFactory.$provide = 'TaskGraph.TaskGraph';
taskGraphFactory.$inject = [
    'Task.taskLibrary',
    'TaskGraph.Store',
    'Constants',
    'Assert',
...
function taskGraphFactory(
    ...
    function TaskGraph(definition, context, domain) {
        ...
        this.domain = domain || Constants.DefaultTaskDomain;
    ...
    TaskGraph.prototype._visitGraphNode = function(
        ...
        var _terminalOnStates = task.terminalOnStates || Constants.FinishedTaskStates;
        ...
        _.forEach(task.waitingOn, function(value, dep) {
            ...
            if (_.contains(value, Constants.TaskStates.Finished)) {
                value = Constants.FinishedTaskStates;
                task.waitingOn[dep] = [Constants.TaskStates.Finished];
            }
    ...
    TaskGraph.prototype._buildTaskDefinition = function(_definition, optionOverrides,
        ...
        definition.state = Constants.TaskStates.Pending;
